  ...
  return (
    <div>
      ...
      <div className='flex items-center gap-2'>
        <label>
            {data.image ? (
                <img src={typeof data.image === 'string' ? data.image : URL.createObjectURL(data.image)} alt="user-image" className="rounded-full object-cover mt-5 ring ring-slate-300
                hover:opacity-80"/>
            ):(
     ...
     {fields.map((field)=>{
        ...
        return(
            <div key={field.key} className='space-y-1 mt-5'>
                ...
                px-3 py-2 border-gray-300 rounded-lg focus:ring
