    ...
    const deleteResume = async (resumeId) => {
        try {
            ...
            if (confirm) {
                ...
                setAllResumes(allResumes.filter(resume => resume._id !== data.resumeId))
                toast.success(data.message)
            }
        } catch (error) {
            toast.error(error?.response?.data?.message || error.message);
    ...
    return (
       ...
       bg-clip-text text-transparent sm:hidden'>Welcome,Joe Doe </p>
        ...
        justify-center rounded-lg gap-2 text-slate-600  border border-dashed  border-slate-300
         group hover:border-indigo-500 hover:shadow-lg transition-all
        ...
        justify-center rounded-lg gap-2 text-slate-600  border border-dashed  border-slate-300
         group hover:border-purple-500 hover:shadow-lg transition-all
         duration-300 cursor-pointer'>
          ...
          duration-300'>Upload Existing</p>
            ...
            z-10 flex items-center justify-center'>
                ...
                hover:text-slate-600 cursor-pointer transitions-colors' onClick={() => {
