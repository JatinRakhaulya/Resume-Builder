...
import { ArrowLeftIcon, Briefcase, User,GraduationCap, FolderIcon, Sparkles, FileText, ChevronLeft, ChevronRight, Share2Icon, EyeOffIcon, DownloadIcon,EyeIcon } from 'lucide-react';
  ...
  return (
    <div>
      <div className='max-w-7xl mx-auto px-4 py-6'>
        ...
        <ArrowLeftIcon/>Back to Dashboard</Link>
    </div>
        ...
        <div className='grid lg:grid-cols-12 gap-8'>
         ...
         <div className='relative lg:col-span-5 rounded-lg overflow-hidden'>
            ...
            p-6 pt-1'>
                ...
                transititon-all rounded-md px-6 py-2 mt-6 text-sm'>
                   Save Changes 
                </button>
