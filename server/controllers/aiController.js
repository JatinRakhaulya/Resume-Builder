...
Make it compelling, ATS-friendly, and return only the final text without any extra explanation.`
                },
                {
                    role: "user",
                    content: userContent
...
The job description should be only 1-2 sentences highlighting key responsibilities
and achievements. Use action verbs and quantifiable results where possible.
Make it ATS-friendly and return only text.`
                },
                {
                    role: "user",
                    content: userContent
